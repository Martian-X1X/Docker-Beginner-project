...
7. Backup Redis data
docker run --rm -v Docker-Beginner-project_redis-data:/data -v %cd%/backups:/backup busybox tar cvf /backup/redis-backup.tar /data
8. Restore Redis data
docker run --rm -v Docker-Beginner-project_redis-data:/data -v %cd%/backups:/backup busybox tar xvf /backup/redis-backup.tar -C /
...
cd C:\Users\Abdul\Docker-Beginner-project
...
# 7. Backup Redis data
mkdir backups
docker run --rm -v Docker-Beginner-project_redis-data:/data -v ${PWD}/backups:/backup busybox tar cvf /backup/redis-backup.tar /data

# 8. Restore Redis data
docker run --rm -v Docker-Beginner-project_redis-data:/data -v ${PWD}/backups:/backup busybox tar xvf /backup/redis-backup.tar -C /
